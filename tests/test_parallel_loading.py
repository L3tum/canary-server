...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="nvidia/canary-1b-v2", help="Model name to load")
    parser.add_argument("--parallel-size", type=int, default=1, help="Number of parallel model instances to load")
